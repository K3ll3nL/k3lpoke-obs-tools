...
contextBridge.exposeInMainWorld('api', {
  ...
  obs: {
    ...
    onSceneListChanged: (cb) => ipcRenderer.on('obs:scene-list-changed', (_, d) => cb(d))
  },
  player: {
  ...
  shiny: {
    ...
    layouts: {
      ...
      setPositionScene: (id, deviceId, shinyScene) => invoke('shiny:layouts:setPositionScene', { id, deviceId, shinyScene })
    }
  },
  marketplace: {
